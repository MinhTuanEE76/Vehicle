...
********************************************************************************/
KeepInCompilation int SectorErase (uint32 EraseStartAddress ,uint32 EraseEndAddress)
{      
  uint32 BlockAddr;
...
********************************************************************************/
KeepInCompilation int Write(uint32 Address, uint32 Size, uint8_t* buffer)
{
  uint32 NumOfPage = 0, NumOfSingle = 0, Addr = 0, count = 0, temp = 0;
  uint32   QSPI_DataNum = 0;
...
/**
  ...
  * Note: Optional for all types of device
  */
KeepInCompilation uint64_t Verify (uint32 MemoryAddr, uint32 RAMBufferAddr, uint32 Size, uint32 missalignement)
{
  uint32 VerifiedData = 0, InitVal = 0;
  uint64_t checksum;
  Size*=4;
