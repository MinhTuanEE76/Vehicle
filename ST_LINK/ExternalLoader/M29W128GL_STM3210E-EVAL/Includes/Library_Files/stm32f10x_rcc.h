...
#else
 #define RCC_PLLSource_PREDIV1            ((uint32)0x00010000)
 #define IS_RCC_PLL_SOURCE(SOURCE) (((SOURCE) == RCC_PLLSource_HSI_Div2) || \
...
/** @defgroup PLL_multiplication_factor 
 ...
 #define RCC_PLLMul_8                    ((uint32)0x00180000)
 #define RCC_PLLMul_9                    ((uint32)0x001C0000)
 #define RCC_PLLMul_6_5                  ((uint32)0x00340000)
...
/** @defgroup PREDIV1_division_factor
  ...
  */
#if defined (STM32F10X_LD_VL) || defined (STM32F10X_MD_VL) || defined (STM32F10X_HD_VL) || defined (STM32F10X_CL)
 #define  RCC_PREDIV1_Div1               ((uint32)0x00000000)
 #define  RCC_PREDIV1_Div2               ((uint32)0x00000001)
 #define  RCC_PREDIV1_Div3               ((uint32)0x00000002)
 #define  RCC_PREDIV1_Div4               ((uint32)0x00000003)
 #define  RCC_PREDIV1_Div5               ((uint32)0x00000004)
 #define  RCC_PREDIV1_Div6               ((uint32)0x00000005)
 #define  RCC_PREDIV1_Div7               ((uint32)0x00000006)
 #define  RCC_PREDIV1_Div8               ((uint32)0x00000007)
 #define  RCC_PREDIV1_Div9               ((uint32)0x00000008)
 #define  RCC_PREDIV1_Div10              ((uint32)0x00000009)
 #define  RCC_PREDIV1_Div11              ((uint32)0x0000000A)
 #define  RCC_PREDIV1_Div12              ((uint32)0x0000000B)
 #define  RCC_PREDIV1_Div13              ((uint32)0x0000000C)
 #define  RCC_PREDIV1_Div14              ((uint32)0x0000000D)
 #define  RCC_PREDIV1_Div15              ((uint32)0x0000000E)
 #define  RCC_PREDIV1_Div16              ((uint32)0x0000000F)
...
/* PREDIV1 clock source (for STM32 connectivity line devices) */
 #define  RCC_PREDIV1_Source_HSE         ((uint32)0x00000000) 
 #define  RCC_PREDIV1_Source_PLL2        ((uint32)0x00010000) 
...
/** @defgroup PREDIV2_division_factor
 ...
 #define  RCC_PREDIV2_Div1               ((uint32)0x00000000)
 #define  RCC_PREDIV2_Div2               ((uint32)0x00000010)
 #define  RCC_PREDIV2_Div3               ((uint32)0x00000020)
 #define  RCC_PREDIV2_Div4               ((uint32)0x00000030)
 #define  RCC_PREDIV2_Div5               ((uint32)0x00000040)
 #define  RCC_PREDIV2_Div6               ((uint32)0x00000050)
 #define  RCC_PREDIV2_Div7               ((uint32)0x00000060)
 #define  RCC_PREDIV2_Div8               ((uint32)0x00000070)
 #define  RCC_PREDIV2_Div9               ((uint32)0x00000080)
 #define  RCC_PREDIV2_Div10              ((uint32)0x00000090)
 #define  RCC_PREDIV2_Div11              ((uint32)0x000000A0)
 #define  RCC_PREDIV2_Div12              ((uint32)0x000000B0)
 #define  RCC_PREDIV2_Div13              ((uint32)0x000000C0)
 #define  RCC_PREDIV2_Div14              ((uint32)0x000000D0)
 #define  RCC_PREDIV2_Div15              ((uint32)0x000000E0)
 #define  RCC_PREDIV2_Div16              ((uint32)0x000000F0)
...
/** @defgroup PLL2_multiplication_factor
 ...
 #define  RCC_PLL2Mul_8                  ((uint32)0x00000600)
 #define  RCC_PLL2Mul_9                  ((uint32)0x00000700)
 #define  RCC_PLL2Mul_10                 ((uint32)0x00000800)
 #define  RCC_PLL2Mul_11                 ((uint32)0x00000900)
 #define  RCC_PLL2Mul_12                 ((uint32)0x00000A00)
 #define  RCC_PLL2Mul_13                 ((uint32)0x00000B00)
 #define  RCC_PLL2Mul_14                 ((uint32)0x00000C00)
 #define  RCC_PLL2Mul_16                 ((uint32)0x00000E00)
 #define  RCC_PLL2Mul_20                 ((uint32)0x00000F00)
...
/** @defgroup PLL3_multiplication_factor
 ...
 #define  RCC_PLL3Mul_8                  ((uint32)0x00006000)
 #define  RCC_PLL3Mul_9                  ((uint32)0x00007000)
 #define  RCC_PLL3Mul_10                 ((uint32)0x00008000)
 #define  RCC_PLL3Mul_11                 ((uint32)0x00009000)
 #define  RCC_PLL3Mul_12                 ((uint32)0x0000A000)
 #define  RCC_PLL3Mul_13                 ((uint32)0x0000B000)
 #define  RCC_PLL3Mul_14                 ((uint32)0x0000C000)
 #define  RCC_PLL3Mul_16                 ((uint32)0x0000E000)
 #define  RCC_PLL3Mul_20                 ((uint32)0x0000F000)
...
#define RCC_AHBPeriph_DMA1               ((uint32)0x00000001)
#define RCC_AHBPeriph_DMA2               ((uint32)0x00000002)
#define RCC_AHBPeriph_SRAM               ((uint32)0x00000004)
#define RCC_AHBPeriph_FLITF              ((uint32)0x00000010)
#define RCC_AHBPeriph_CRC                ((uint32)0x00000040)

#ifndef STM32F10X_CL
 #define RCC_AHBPeriph_FSMC              ((uint32)0x00000100)
 #define RCC_AHBPeriph_SDIO              ((uint32)0x00000400)
 #define IS_RCC_AHB_PERIPH(PERIPH) ((((PERIPH) & 0xFFFFFAA8) == 0x00) && ((PERIPH) != 0x00))
#else
 #define RCC_AHBPeriph_OTG_FS            ((uint32)0x00001000)
 #define RCC_AHBPeriph_ETH_MAC           ((uint32)0x00004000)
 #define RCC_AHBPeriph_ETH_MAC_Tx        ((uint32)0x00008000)
 #define RCC_AHBPeriph_ETH_MAC_Rx        ((uint32)0x00010000)
...
#define RCC_APB2Periph_GPIOF             ((uint32)0x00000080)
#define RCC_APB2Periph_GPIOG             ((uint32)0x00000100)
...
#define RCC_APB2Periph_TIM8              ((uint32)0x00002000)
#define RCC_APB2Periph_USART1            ((uint32)0x00004000)
#define RCC_APB2Periph_ADC3              ((uint32)0x00008000)
#define RCC_APB2Periph_TIM15             ((uint32)0x00010000)
#define RCC_APB2Periph_TIM16             ((uint32)0x00020000)
#define RCC_APB2Periph_TIM17             ((uint32)0x00040000)
#define RCC_APB2Periph_TIM9              ((uint32)0x00080000)
#define RCC_APB2Periph_TIM10             ((uint32)0x00100000)
#define RCC_APB2Periph_TIM11             ((uint32)0x00200000)
...
#define RCC_APB1Periph_TIM5              ((uint32)0x00000008)
#define RCC_APB1Periph_TIM6              ((uint32)0x00000010)
#define RCC_APB1Periph_TIM7              ((uint32)0x00000020)
#define RCC_APB1Periph_TIM12             ((uint32)0x00000040)
#define RCC_APB1Periph_TIM13             ((uint32)0x00000080)
#define RCC_APB1Periph_TIM14             ((uint32)0x00000100)
...
#define RCC_APB1Periph_UART4             ((uint32)0x00080000)
#define RCC_APB1Periph_UART5             ((uint32)0x00100000)
...
#define RCC_APB1Periph_CAN1              ((uint32)0x02000000)
#define RCC_APB1Periph_CAN2              ((uint32)0x04000000)
#define RCC_APB1Periph_BKP               ((uint32)0x08000000)
#define RCC_APB1Periph_PWR               ((uint32)0x10000000)
#define RCC_APB1Periph_DAC               ((uint32)0x20000000)
#define RCC_APB1Periph_CEC               ((uint32)0x40000000)
...
#if defined (STM32F10X_LD_VL) || defined (STM32F10X_MD_VL) || defined (STM32F10X_HD_VL) || defined (STM32F10X_CL)
 void RCC_PREDIV1Config(uint32 RCC_PREDIV1_Source, uint32 RCC_PREDIV1_Div);
#endif

#ifdef  STM32F10X_CL
 void RCC_PREDIV2Config(uint32 RCC_PREDIV2_Div);
 void RCC_PLL2Config(uint32 RCC_PLL2Mul);
 void RCC_PLL2Cmd(FunctionalState NewState);
 void RCC_PLL3Config(uint32 RCC_PLL3Mul);
 void RCC_PLL3Cmd(FunctionalState NewState);
#endif /* STM32F10X_CL */ 

void RCC_SYSCLKConfig(uint32 RCC_SYSCLKSource);
uint8_t RCC_GetSYSCLKSource(void);
void RCC_HCLKConfig(uint32 RCC_SYSCLK);
void RCC_PCLK1Config(uint32 RCC_HCLK);
void RCC_PCLK2Config(uint32 RCC_HCLK);
void RCC_ITConfig(uint8_t RCC_IT, FunctionalState NewState);

#ifndef STM32F10X_CL
 void RCC_USBCLKConfig(uint32 RCC_USBCLKSource);
#else
 void RCC_OTGFSCLKConfig(uint32 RCC_OTGFSCLKSource);
#endif /* STM32F10X_CL */ 

void RCC_ADCCLKConfig(uint32 RCC_PCLK2);

#ifdef STM32F10X_CL
 void RCC_I2S2CLKConfig(uint32 RCC_I2S2CLKSource);                                  
 void RCC_I2S3CLKConfig(uint32 RCC_I2S3CLKSource);
#endif /* STM32F10X_CL */ 
...
#ifdef STM32F10X_CL
void RCC_AHBPeriphResetCmd(uint32 RCC_AHBPeriph, FunctionalState NewState);
#endif /* STM32F10X_CL */ 
