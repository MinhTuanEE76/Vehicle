...
typedef __IO uint32  vu32;
typedef __IO uint16_t vu16;
typedef __IO uint8_t  vu8;

typedef __I uint32 vuc32;  /*!< Read Only */
...
/*!< PTP_PPS_REMAP configuration */
 #define AFIO_MAPR_PTP_PPS_REMAP              ((uint32)0x40000000)        /*!< PTP_PPS_REMAP bit (Ethernet PTP PPS remapping) */
#endif
...
/*!< UFSR */
#define  SCB_CFSR_UNDEFINSTR                 ((uint32)0x00010000)        /*!< The processor attempt to execute an undefined instruction */
...
#define  SCB_HFSR_VECTTBL                    ((uint32)0x00000002)        /*!< Fault occurs because of vector table read on exception processing */
...
#define  DMA_IFCR_CGIF1                      ((uint32)0x00000001)        /*!< Channel 1 Global interrupt clear */
...
#define  ADC_CR1_AWDIE                       ((uint32)0x00000040)        /*!< Analog Watchdog interrupt enable */
...
#define  SDIO_MASK_CMDACTIE                  ((uint32)0x00000800)        /*!< Command Acting Interrupt Enable */
