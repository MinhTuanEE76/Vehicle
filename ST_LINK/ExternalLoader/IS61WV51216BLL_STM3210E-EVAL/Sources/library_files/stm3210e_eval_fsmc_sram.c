...
/**
  ...
  * @retval None
  */
void SRAM_WriteBuffer(uint16_t* pBuffer, uint32 WriteAddr, uint32 NumHalfwordToWrite)
{
...
/**
  ...
  * @retval None
  */
void SRAM_ReadBuffer(uint16_t* pBuffer, uint32 ReadAddr, uint32 NumHalfwordToRead)
{
