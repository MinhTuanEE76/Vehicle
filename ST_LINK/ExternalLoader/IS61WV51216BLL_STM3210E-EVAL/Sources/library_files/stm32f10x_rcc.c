...
/* CFGR register bit mask */
 ...
 #define CFGR_PLL_Mask            ((uint32)0xFFC2FFFF)
#else
...
#define CSR_RMVF_Set              ((uint32)0x01000000)

#if defined (STM32F10X_LD_VL) || defined (STM32F10X_MD_VL) || defined (STM32F10X_HD_VL) || defined (STM32F10X_CL) 
/* CFGR2 register bit mask */
 #define CFGR2_PREDIV1SRC         ((uint32)0x00010000)
 #define CFGR2_PREDIV1            ((uint32)0x0000000F)
#endif
#ifdef STM32F10X_CL
 #define CFGR2_PREDIV2            ((uint32)0x000000F0)
 #define CFGR2_PLL2MUL            ((uint32)0x00000F00)
 #define CFGR2_PLL3MUL            ((uint32)0x0000F000)
#endif /* STM32F10X_CL */ 
...
#define CIR_BYTE2_ADDRESS         ((uint32)0x40021009)

/* CIR register byte 3 (Bits[23:16]) base address */
#define CIR_BYTE3_ADDRESS         ((uint32)0x4002100A)

/* CFGR register byte 4 (Bits[31:24]) base address */
#define CFGR_BYTE4_ADDRESS        ((uint32)0x40021007)
...
void RCC_HSICmd(FunctionalState NewState)
{
  ...
  *(__IO uint32 *) CR_HSION_BB = (uint32)NewState;
}
...
void RCC_PLLCmd(FunctionalState NewState)
{
  ...
  *(__IO uint32 *) CR_PLLON_BB = (uint32)NewState;
}
...
void RCC_PLL2Cmd(FunctionalState NewState)
{
  ...
  *(__IO uint32 *) CR_PLL2ON_BB = (uint32)NewState;
}
...
void RCC_PLL3Cmd(FunctionalState NewState)
{
  ...
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  *(__IO uint32 *) CR_PLL3ON_BB = (uint32)NewState;
}
#endif /* STM32F10X_CL */
...
void RCC_USBCLKConfig(uint32 RCC_USBCLKSource)
{
  ...
  *(__IO uint32 *) CFGR_USBPRE_BB = RCC_USBCLKSource;
}
#else
/**
...
void RCC_OTGFSCLKConfig(uint32 RCC_OTGFSCLKSource)
{
  ...
  *(__IO uint32 *) CFGR_OTGFSPRE_BB = RCC_OTGFSCLKSource;
}
#endif /* STM32F10X_CL */ 
...
void RCC_I2S2CLKConfig(uint32 RCC_I2S2CLKSource)
{
  ...
  *(__IO uint32 *) CFGR2_I2S2SRC_BB = RCC_I2S2CLKSource;
}
...
void RCC_I2S3CLKConfig(uint32 RCC_I2S3CLKSource)
{
  ...
  *(__IO uint32 *) CFGR2_I2S3SRC_BB = RCC_I2S3CLKSource;
}
#endif /* STM32F10X_CL */
...
void RCC_LSICmd(FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  *(__IO uint32 *) CSR_LSION_BB = (uint32)NewState;
}
...
void RCC_RTCCLKCmd(FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  *(__IO uint32 *) BDCR_RTCEN_BB = (uint32)NewState;
}
...
void RCC_BackupResetCmd(FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  *(__IO uint32 *) BDCR_BDRST_BB = (uint32)NewState;
}
...
void RCC_ClockSecuritySystemCmd(FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  *(__IO uint32 *) CR_CSSON_BB = (uint32)NewState;
}
