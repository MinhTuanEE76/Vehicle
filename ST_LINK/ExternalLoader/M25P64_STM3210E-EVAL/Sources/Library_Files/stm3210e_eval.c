...
//                                 LED4_PIN};
//const uint32 GPIO_CLK[LEDn] = {LED1_GPIO_CLK, LED2_GPIO_CLK, LED3_GPIO_CLK,
//                                 LED4_GPIO_CLK};
//
...
//
//const uint32 BUTTON_CLK[BUTTONn] = {WAKEUP_BUTTON_GPIO_CLK, TAMPER_BUTTON_GPIO_CLK,
...
// 
//const uint32 COM_USART_CLK[COMn] = {EVAL_COM1_CLK, EVAL_COM2_CLK};
//
//const uint32 COM_TX_PORT_CLK[COMn] = {EVAL_COM1_TX_GPIO_CLK, EVAL_COM2_TX_GPIO_CLK};
// 
//const uint32 COM_RX_PORT_CLK[COMn] = {EVAL_COM1_RX_GPIO_CLK, EVAL_COM2_RX_GPIO_CLK};
//
...
/**
  ...
  */
//uint32 STM_EVAL_PBGetState(Button_TypeDef Button)
//{
...
/**
  ...
  * @retval None
  */
//void SD_LowLevel_DMA_TxConfig(uint32 *BufferSRC, uint32 BufferSize)
//{
//
...
/**
  ...
  * @retval None
  */
//void SD_LowLevel_DMA_RxConfig(uint32 *BufferDST, uint32 BufferSize)
//{
//  DMA_InitTypeDef DMA_InitStructure;
//
//  DMA_ClearFlag(DMA2_FLAG_TC4 | DMA2_FLAG_TE4 | DMA2_FLAG_HT4 | DMA2_FLAG_GL4);
...
/**
  ...
  */
//uint32 SD_DMAEndOfTransferStatus(void)
//{
