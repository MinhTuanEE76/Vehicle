...
/**
  ...
  * @retval None
  */
void sFLASH_WritePage(uint8_t* pBuffer, uint32 WriteAddr, uint32 NumByteToWrite)
{
...
/**
  ...
  * @retval None
  */
void sFLASH_WriteBuffer(uint8_t* pBuffer, uint32 WriteAddr, uint32 NumByteToWrite)
{
...
/**
  ...
  * @retval None
  */
void sFLASH_ReadBuffer(uint8_t* pBuffer, uint32 ReadAddr, uint32 NumByteToRead)
{
  /*!< Select the FLASH: Chip Select low */
  sFLASH_CS_LOW();
...
/**
  ...
  * @retval None
  */
void sFLASH_StartReadSequence(uint32 ReadAddr)
{
  /*!< Select the FLASH: Chip Select low */
  sFLASH_CS_LOW();
